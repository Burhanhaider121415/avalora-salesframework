...
interface StartViewProps {
  onSelectMode: (scenario: string | null, workspace: 'medspa' | 'partner') => void;
  onOpenSafety: () => void;
}
  ...
  return (
    <div className="flex-col gap-6 pb-6">
      ...
      <div className="flex-col gap-4">
        ...
        <button className="card btn-secondary" onClick={() => onSelectMode(null, 'medspa')} style={{ textAlign: 'left', padding: '16px' }}>
      ...
      <div className="flex-col gap-4 mt-6">
        ...
        <button className="card btn-secondary" onClick={() => onSelectMode('partner_gatekeeper', 'partner')} style={{ textAlign: 'left', padding: '16px', borderColor: 'var(--color-muted-sage)' }}>
