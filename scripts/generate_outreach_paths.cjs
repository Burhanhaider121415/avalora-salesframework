  ...
  email_mode: {
    ...
    nodes: {
      executive_directive: {
        ...
        branchButtons: [{ id: 'conversion_path', label: '2. Conversion path', target: 'conversion_path' }]
      },
      conversion_path: {
        id: 'conversion_path',
        ...
        branchButtons: [{ id: 'buyer_psychology', label: '3. Buyer psychology', target: 'buyer_psychology' }, { id: 'back', label: 'Back', target: 'executive_directive' }]
      },
      buyer_psychology: {
        id: 'buyer_psychology',
        ...
        branchButtons: [{ id: 'research_card', label: '4. Write from research card', target: 'research_card' }, { id: 'back', label: 'Back', target: 'conversion_path' }]
      },
      research_card: {
        id: 'research_card',
        ...
        branchButtons: [{ id: 'email_chassis', label: '5. Email chassis', target: 'email_chassis' }, { id: 'back', label: 'Back', target: 'buyer_psychology' }]
      },
      email_chassis: {
        id: 'email_chassis',
        ...
        branchButtons: [{ id: 'subject_line', label: '6. Subject line strategy', target: 'subject_line' }, { id: 'back', label: 'Back', target: 'research_card' }]
      },
      subject_line: {
        id: 'subject_line',
        ...
        branchButtons: [{ id: 'personalization', label: '7. Personalization system', target: 'personalization' }, { id: 'back', label: 'Back', target: 'email_chassis' }]
      },
      personalization: {
        id: 'personalization',
        ...
        branchButtons: [{ id: 'cta_ladder', label: '8. CTA ladder', target: 'cta_ladder' }, { id: 'back', label: 'Back', target: 'subject_line' }]
      },
      cta_ladder: {
        id: 'cta_ladder',
        ...
        branchButtons: [{ id: 'email_families', label: '9. Email families', target: 'email_families' }, { id: 'back', label: 'Back', target: 'personalization' }]
      },
      email_families: {
        id: 'email_families',
        ...
        branchButtons: [{ id: 'follow_up', label: '10. Follow-up philosophy', target: 'follow_up' }, { id: 'back', label: 'Back', target: 'cta_ladder' }]
      },
      follow_up: {
        id: 'follow_up',
        ...
        branchButtons: [{ id: 'language_rules', label: '12. Language rules', target: 'language_rules' }, { id: 'back', label: 'Back', target: 'email_families' }]
      },
      language_rules: {
        id: 'language_rules',
        ...
        branchButtons: [{ id: 'qa', label: '13-17. QA & Standards', target: 'qa' }, { id: 'back', label: 'Back', target: 'follow_up' }]
      },
      qa: {
        id: 'qa',
        ...
        branchButtons: [{ id: 'disposition', label: 'End / Disposition', target: 'disposition' }, { id: 'back', label: 'Back', target: 'language_rules' }]
      },
      disposition: {
        id: 'disposition',
  ...
  ig_mode: {
    ...
    nodes: {
      core_goal: {
        ...
        branchButtons: [{ id: 'mandate', label: '2. The copywriter mandate', target: 'mandate' }]
      },
      mandate: {
        id: 'mandate',
        ...
        branchButtons: [{ id: 'conversion_path', label: '3. The conversion path', target: 'conversion_path' }, { id: 'back', label: 'Back', target: 'core_goal' }]
      },
      conversion_path: {
        id: 'conversion_path',
        ...
        branchButtons: [{ id: 'psychology', label: '4. Buyer psychology', target: 'psychology' }, { id: 'back', label: 'Back', target: 'mandate' }]
      },
      psychology: {
        id: 'psychology',
        ...
        branchButtons: [{ id: 'input_required', label: '6. Required input', target: 'input_required' }, { id: 'back', label: 'Back', target: 'conversion_path' }]
      },
      input_required: {
        id: 'input_required',
        ...
        branchButtons: [{ id: 'dm_families', label: '8. DM families', target: 'dm_families' }, { id: 'back', label: 'Back', target: 'psychology' }]
      },
      dm_families: {
        id: 'dm_families',
        ...
        branchButtons: [{ id: 'personalization_levels', label: '9. Personalization levels', target: 'personalization_levels' }, { id: 'back', label: 'Back', target: 'input_required' }]
      },
      personalization_levels: {
        ...
        branchButtons: [{ id: 'follow_up', label: '11. Follow-up & 12. Reply handling', target: 'follow_up' }, { id: 'back', label: 'Back', target: 'dm_families' }]
      },
      follow_up: {
        id: 'follow_up',
        ...
        branchButtons: [{ id: 'qa', label: '13-18. Tone, QA, & Standard', target: 'qa' }, { id: 'back', label: 'Back', target: 'personalization_levels' }]
      },
      qa: {
        id: 'qa',
        ...
        branchButtons: [{ id: 'disposition', label: 'End / Disposition', target: 'disposition' }, { id: 'back', label: 'Back', target: 'follow_up' }]
      },
      disposition: {
        id: 'disposition',
        stage: 'Execution Next Steps',
...
fs.writeFileSync('temp_outreachPaths.json', JSON.stringify(outreachPaths, null, 2));
console.log('done');
